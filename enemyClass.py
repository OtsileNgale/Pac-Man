...
class Enemy:
    ...
    def set_speed(self):
        if self.personality in ["fast", "scared"]:
            speed = 1.5
        else:
            speed = 2
        return speed
    ...
    def get_pix_pos(self):
        return vector((self.grid_pos.x*self.app.cell_width)+TOP_BOTTOM_BUFFER//2+self.app.cell_width//2,
