...
############################ HELPER FUNCTIONS ##################################
        ...
        with open("field.txt", 'r') as file:
            for yidx, line in enumerate(file):
                for xidx, char in enumerate(line):
                    if char == "1":
                        self.field.append(vector(xidx, yidx))
                    elif char == "C":
                        self.tokens.append(vector(xidx, yidx))
                    elif char == "P":
    ...
    def reset(self):
        ...
        for enemy in self.enemies:
            enemy.grid_pos = vector(enemy.starting_pos)
...
########################### INTRO FUNCTIONS ####################################
    ...
    def start_draw(self):
        ...
        self.draw_text('PRESS SPACE BAR TO START', self.screen, [
                       WIDTH//2, HEIGHT//2-50], START_TEXT_SIZE, (170, 132, 58), START_FONT, centered=True)
        self.draw_text('1 PLAYER', self.screen, [
                       WIDTH//2, HEIGHT//2+50], START_TEXT_SIZE, (44, 167, 198), START_FONT, centered=True)
        self.draw_text('HIGH SCORE', self.screen, [4, 0],
                       START_TEXT_SIZE, (255, 255, 255), START_FONT)
        self.draw_text('ARE YOU READY?', self.screen, [
                       WIDTH//2, HEIGHT//3-50], START_TEXT_SIZE, (170, 132, 58), START_FONT, centered=True)
